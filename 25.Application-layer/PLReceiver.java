...
public class PLReceiver {
   ...
   public static void main(String[] args) throws IOException, ClassNotFoundException {
      ...
      DatagramPacket output = new DatagramPacket(sendData, sendData.length, address, 6666);
      sender.send(output);
      ...
      // MLT-3
      String afterMlt = mlt(data.getAck());
      data.setAck(afterMlt);
      ...
      output = new DatagramPacket(sendData, sendData.length, address, 1111);
      sender.send(output);
